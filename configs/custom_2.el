...
(custom-set-variables
 ...
 '(package-selected-packages
   '(all-the-icons blacken centered-cursor-mode centered-window
		   company-org-block company-quickhelp counsel
		   dashboard direnv doom-modeline ein elpy
		   evil-collection flycheck helpful ivy-posframe
		   ivy-rich jupyter jupyter-ascending nix-mode
		   no-littering org-bullets rainbow-delimiters
		   rainbow-mode)))
(custom-set-faces
 ...
 '(org-block-begin-line ((t (:box (:line-width 3 :color "purple") :foreground "purple" :background "#46005f" :extend t))))
 '(org-block-end-line ((t (:box (:line-width 3 :color "purple") :foreground "purple" :background "#46005f" :extend t))))
 '(vertical-border ((t (:foreground "#5e81ac"))))
